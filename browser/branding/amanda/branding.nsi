...
# NSIS branding defines for amanda builds.
# The official release build branding.nsi is located in other-license/branding/firefox/
# The unofficial build branding.nsi is located in browser/branding/unofficial/

# BrandFullNameInternal is used for some registry and file system values
# instead of BrandFullName and typically should not be modified.
!define BrandFullNameInternal "Amanda"
!define CompanyName           "lkpp.go.id"
!define URLInfoAbout          "https://www.lkpp.go.id"
!define HelpLink              "http://www.lkpp.go.id/v3/#/hubungi_kami"

!define URLStubDownload "http://download.lkpp.go.id/?os=win&lang=${AB_CD}&product=amanda-latest"
!define URLManualDownload "https://www.lkpp.go.id/${AB_CD}/amanda/installer-help/?channel=amanda&installer_lang=${AB_CD}"
!define Channel "amanda"
