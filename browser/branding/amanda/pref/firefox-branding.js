...
pref("startup.homepage_welcome_url","http://lkpp.go.id");
...
// attempts fail.
pref("app.update.url.manual", "http://lkpp.go.id/amanda");
// A default value for the "More information about this update" link
// supplied in the "An update is available" page of the update wizard.
pref("app.update.url.details", "http://lkpp.go.id/firefox/aurora/");
